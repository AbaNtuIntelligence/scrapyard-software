...
# Scale reading function (mock for now - replace with actual serial)
def get_current_weight():
    # For testing, return a random weight
    # Replace this with actual serial port reading
...
def dashboard():
    ...
    for row in rows:
        ...
        if trans.get('timestamp'):
            # SQLite returns timestamp as string like "2026-06-01 14:30:00"
